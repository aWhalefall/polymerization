...
import com.base.webview.webview.bean.WebBankBean;
import com.base.webview.webview.bean.WebSendMessageBean;
import com.base.webview.webview.parser.JSMsgParser;
import com.base.webview.webview.parser.MsgParser;
...
//        mActivity.startActivity(intent);
    ...
    private void handPunch() {
        EventBusHelper.post(new HandPunchEven(mActivity));
    }
