...
//        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams((int) Utils.dp2px(getContext(), 9),
//                (int) Utils.dp2px(getContext(), 9));
    ...
    void adjustPositionAndSize(BottomBarTab tab) {
        ...
        float xOffset = (float) (iconView.getWidth() / 1.5); //1.25

        setX(iconView.getX() + xOffset);
        //todo
        setTranslationY(10); //10
