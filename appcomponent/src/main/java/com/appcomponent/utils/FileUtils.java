...
public final class FileUtils {
     ...
     * String 路径
     */
    public static String BASE_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+"/polymerization/";
    public static String LOG_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+"/polymerization/Logger/";
    ...
    public static void writeInternalFile(Context ctx, String fileName, String data) {
        try {
    ...
    public static String readInternalFile(Context ctx, String fileName) {
