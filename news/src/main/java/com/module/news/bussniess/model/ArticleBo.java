...
public class ArticleBo {
    ...
    public int size;
    public int total;
    public List<DatasBo> datas;

    public static class DatasBo {
        /**
         * apkLink :
         * author : JackMeGo
         * chapterId : 268
         ...
         * fresh : false
         * id : 7541
         * link : https://www.jianshu.com/p/fda5cf1d3e6a
         * niceDate : 2天前
         * origin :
         * projectLink :
         * publishTime : 1542725707000
         * superChapterId : 135
         * superChapterName : 项目必备
         * tags : []
         * title : Android版结巴分词：原理、接入和启动优化
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0
